...
def main():
    ...
    want_menu = string_checker(f"Hello {name}, would you like the menu? ", yes_no_options)
...
''')
        ...
        while keep_going == "yes":
                ...
                print()
                keep_going = string_checker("Do you want to order another pizza? ", yes_no_options)
    ...
    want_drink_menu = string_checker(f"Hello {name}, would you like the drink menu? ", yes_no_options)
...
''')
        ...
        while keep_going == "yes":
                ...
                print()
                keep_going = string_checker("Do you want to order another drink? ", yes_no_options)
